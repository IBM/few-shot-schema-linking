...
Based on the evaluation script from the BIRD github repository. 
...
def package_sqls(sql_path, db_root_path):
    clean_sqls = []
    db_path_list = []
...
if __name__ == '__main__':
    ...
    pred_queries, db_paths = package_sqls(args.predicted_sql_path, args.db_root_path)
    # generate gt sqls:
    gt_queries, db_paths_gt = package_sqls(args.ground_truth_path, args.db_root_path)
