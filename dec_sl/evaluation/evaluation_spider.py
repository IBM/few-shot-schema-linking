...
from dec_sl.evaluation.process_sql import tokenize, get_schema, get_tables_with_alias, Schema, get_sql
...
def print_scores(scores, etype):
    ...
    if etype in ["all", "exec"]:
        ...
        print("{:20} {:<20.3f} {:<20.3f} {:<20.3f} {:<20.3f} {:<20.4f}".format("execution", *this_scores))
